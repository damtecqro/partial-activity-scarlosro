...
import com.test.pokedex.Activities.detailed
...
class AdapterList:RecyclerView.Adapter<AdapterList.ViewHolder>() {
    ...
    class ViewHolder(view: View):RecyclerView.ViewHolder(view){
        ...
        private var myVista = view


        fun bind(item:JsonObject,context:Context){

            myVista.tag= position
            imagePokemon.setOnClickListener{
                val posicion = myVista.tag as Int
                var intent: Intent = Intent(context, detailed::class.java)
